    ...
    public static void main(String[] args) {
        ...
        while (systemRunning) {
            ...
            while (running) {
                ...
                System.out.println("6. Показать статистику"); // 3
                System.out.println("7. Топ-3 аппарата по дальности "); // 3
                ...
                if (isAdmin) {
                    ...
                    System.out.println("17. Экспорт базы в CSV ");  // 3
                    System.out.println("18. Выполнить ТО всего парка"); // 3
                    System.out.println("19. Арендовать выбранный аппарат"); // 3
                    System.out.println("20. Выполнить ТО для выбранного аппарата"); // 3
                }
                ...
                switch (choice) {
                    ...
                    case 7: manager.showTopRange(); break; // ЛР 3
                    ...
                    case 19:
                        manager.showAllWithIndexes();
                        int rentIdx = readInt(sc, "\nВведите индекс аппарата для аренды: ");
                        int days = readInt(sc, "На сколько дней арендовать: ");
                        manager.rentAircraft(rentIdx, days);
                        break;

                    case 20:
                        manager.showAllWithIndexes();
                        int maintIdx = readInt(sc, "\nВведите индекс аппарата для ТО: ");
                        manager.performMaintenanceOn(maintIdx);
                        break;
                    case 0:
